...
public class CategoryService {
	 ...
	 * 카테고리 전체 조회
	 */
	public List<CategorySummaryResponse> findAll(String loginId) {
		Member member = memberRepository.findByStudentId(loginId)
			.orElseThrow(() -> new CustomException(MEMBER_NOT_FOUND));

		Department department = member.getDepartment();

		List<Category> allCategoryList = categoryRepository.findAllByDepartment(department);
	 ...
	 */
	@Transactional
	public void createCategory(String loginId, CategoryCreateRequest request) {
		Member member = memberRepository.findByStudentId(loginId)
			.orElseThrow(() -> new CustomException(MEMBER_NOT_FOUND));
	 ...
	 */
	@Transactional
	public void deleteCategory(String loginId, Long categoryId) {
		Member member = memberRepository.findByStudentId(loginId)
			.orElseThrow(() -> new CustomException(MEMBER_NOT_FOUND));
